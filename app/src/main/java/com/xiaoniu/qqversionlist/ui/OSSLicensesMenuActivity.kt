...
class OSSLicensesMenuActivity : ComponentActivity() {
    ...
    @Composable
    fun OSSLicensesMenu(lib: Libs? = null) {
        var libs = lib
        if (libs == null) libs =
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                libs.libraries.forEach { library ->
                    item {
                        var versionWidth by remember { mutableStateOf(20.sp) }
                        val version = library.artifactVersion
                        Box(
                            modifier = Modifier.clickable(onClick = {
                                if (library.licenses.isNotEmpty() || library.website != null) {
                                    OSSLicensesObject.setCurrentLibrary(library)
                                    val intent = Intent(
                                        this@OSSLicensesMenuActivity,
                            ...
                            Box(
                                ...
                                Column {
                                    ...
                                    val developers = library.developers as List<Developer>
                                            ...
                                            developers.withIndex().forEach { (index, developer) ->
                                                if (!developer.organisationUrl.isNullOrEmpty()) Text(
                                                    ...
                                                    modifier = Modifier.clickable(indication = null,
                                                        ...
                                                        onClick = {
                                                            val url =
                                                                developer.organisationUrl.toString()
                                                            val intent =
                                    ...
                                    FlowRow(
                                        ...
                                        Card(
                                            ...
                                            Text(text = if (version.toString().first()
                                                    .isDigit()
                                                ...
                                                onTextLayout = { textLayoutResult ->
                                                    versionWidth =
                                                        with(density) { textLayoutResult.size.width.toSp() }
                                                })
                                        }
              ...
              "libraries": [
                {
                  ...
                  "name": "ABC MaterialDrawer Library qqqqqq qqqqqqqqqq qqqqqqqqqqqqqq qqqqqqqqqq",
