...
> 此用户协议于 2024 年 3 月 11 日修订，并于 2024 年 3 月 12 日实施。
...
您可以直接从官方渠道获取 QQ 版本列表实用工具。

如果您从未经相关官方平台获取本应用，QQ 版本列表实用工具无法保证该应用能够正常使用，并对因此给您造成的损失不予负责。获取应用后，您需要按照该应用提示的步骤正确使用。
...
除非法律允许或 QQ 版本列表实用工具的书面许可，您使用 QQ 版本列表实用工具过程中不得删除 QQ 版本列表实用工具及其副本上关于知识产权的信息，不得对 QQ 版本列表实用工具进行反向工程等或以其他方式尝试发现 QQ 版本列表实用工具的源代码。
